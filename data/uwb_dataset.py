...
def generate_from_csv_files(rootdir):
    ...
    labels_path = '/Users/bytedance/Desktop/ZFS/LOS_NLOS_Identification/data/dataset/labels.npy'
    CIRs_path = '/Users/bytedance/Desktop/ZFS/LOS_NLOS_Identification/data/dataset/CIRs.npy'
...
def generate_images_file():
    CIR_path = '/Users/bytedance/Desktop/ZFS/LOS_NLOS_Identification/data/dataset/CIRs.npy'
    CIR_vec = np.load(CIR_path)
    scales = np.arange(1, 129)
    grayscale_images_vector = np.empty((len(CIR_vec), 128, 128))
    # 检查文件是否已存在，如果存在则跳过
    if os.path.exists('/Users/bytedance/Desktop/ZFS/LOS_NLOS_Identification/data/grayscale_images/gray_images_part.npy'):
        print("Gray images file already exists. Skipping.")
        print("grayscale_images_vector.shape:",grayscale_images_vector.shape)
        return

    for i in tqdm(range(len(CIR_vec)),desc="CIRs"):
    ...
    gray_images_path = '/Users/bytedance/Desktop/ZFS/LOS_NLOS_Identification/data/grayscale_images/gray_images_part.npy'
    np.save(gray_images_path, grayscale_images_vector)
    print("Done")

if __name__ == '__main__':
    # Import raw data from folder with dataset
    # rootdir = '/Users/bytedance/Desktop/ZFS/LOS_NLOS_Identification/data'
